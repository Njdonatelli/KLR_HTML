...
|---------|------|--------|--------|
| v1.0 | 2026-08-17 | Tech Manager | Initial. Stack inventory + least-privilege role matrix; MFA + secrets-manager credential governance; same-day offboarding; quarterly access review. |

...
|---------|------|--------|--------|
| v1.0 | 2026-08-17 | Sales Lead | Initial. Multi-channel intake normalized to SalesRabbit; hard-gate + soft-signal rubric; M365 shared mailbox as canonical email intake. |

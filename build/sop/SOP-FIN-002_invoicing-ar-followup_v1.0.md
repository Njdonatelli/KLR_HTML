...
|---------|------|--------|--------|
| v1.0 | 2026-08-17 | Admin/Finance | Initial. [1-day] issuance off verified milestones; weekly AR aging; tiered overdue cadence with lien-deadline awareness (verify). |

...
|---------|------|--------|--------|
| v1.0 | 2026-08-17 | Sales Lead | Initial. [1-hr] speed-to-book; M365-calendar consult with context; decision-maker confirmation + automated reminder cadence to cut no-shows. |

...
|---------|------|--------|--------|
| v1.0 | 2026-08-17 | Sales Lead | Initial. SalesRabbit→CF sync (no re-key); context pack + mandatory Design Lead acknowledgment; manual fallback on automation failure. |

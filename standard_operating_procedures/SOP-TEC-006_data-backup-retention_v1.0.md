...
|---------|------|--------|--------|
| v1.0 | ____ | Tech Manager | Initial. Backup inventory + per-class schedule; 3-2-1 with "sync ≠ backup" principle; legal-aware retention (verify); quarterly restore testing; resolves TEC-007 backup dependency. |

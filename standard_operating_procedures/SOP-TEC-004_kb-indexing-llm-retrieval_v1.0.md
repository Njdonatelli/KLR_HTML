...
|---------|------|--------|--------|
| v1.0 | ____ | Tech Manager | Initial. Source inventory + JSON/JSONL schema with provenance; Active-only-authoritative indexing; monthly retrieval eval; superseded-record retirement. SOP corpus treated as a first-class source. |

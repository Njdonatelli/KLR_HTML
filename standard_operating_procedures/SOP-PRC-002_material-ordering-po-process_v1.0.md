...
|---------|------|--------|--------|
| v1.0 | ____ | Ops | Initial (closes the P1 register gap). Takeoff-traceable PO with approval gate + variance flag; 3-way-match close; change propagation to PRO-003/CON-004. |

...
|---------|------|--------|--------|
| v1.0 | ____ | Production Lead | Initial. Takeoff-derived JIT materials plan tied to schedule; long-lead ordered at kickoff; perishables timed to install; delay propagation to PRO-002/CON-004. |
